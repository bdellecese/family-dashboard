    ...
    *
    * This ensures that once the current Monday-Friday school
    * week has ended, the widget displays the next week's menu.
    *
    * Examples:
    *
    *     Monday 8/17 -> 8/17
    ...
    */
    ...
    function getUpcomingSchoolWeekMonday(
        ...
        * Sunday   = 0
        *
        * The current school week is finished, so move to
